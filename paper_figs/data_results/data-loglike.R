...
model_list[[2]] <- c("smear", "hiv_pos")
model_list[[3]] <- c("smear", "hiv_pos", "scaled_rel_time")
model_list[[4]] <- c("smear", "hiv_pos", "scaled_rel_time",
                     "race_asian_white", "race_black_white")
model_list[[5]] <- c("hiv_pos")
model_list[[6]] <- c("hiv_pos", "smear", "smear_pos_hiv_pos")
model_list[[7]] <- c("age_scaled")
model_list[[8]] <- c("scaled_rel_time")
model_list[[9]] <- c("scaled_rel_time", "hiv_pos")
model_list[[10]] <- c("rel_time", "max_rel_time")
model_list[[11]] <- c("scaled_med_rel_time")
model_list[[12]] <- c("scaled_max_rel_time")
model_list[[13]] <- c("min_time", "max_time", "time")
B <- 1000
...
for(ii in 13:length(model_list)){
