...
2. [Accounting for under-reporting (Multiple outside transmission model)](not-built-vignettes/multiple-outside-transmissions-model.html)
3. [Sampling from $\mathcal{T}_n$](not-built-vignettes/sampling-mc-trees.html)
...
3. [Simulations to assess whether we sampled enough MC trees](simulations-enough-mc-trees.html)
