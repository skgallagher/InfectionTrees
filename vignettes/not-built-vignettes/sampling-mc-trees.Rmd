...
4. Permute the covariate labels to the $n$ nodes.
...
Conditioned on the number of generations $g$, we would like to uniformly draw a $g-tuple$ $(n_1, \dots, n_g)$ such that $n_1=1$ and $\sum_{i=1}^g = n$.
