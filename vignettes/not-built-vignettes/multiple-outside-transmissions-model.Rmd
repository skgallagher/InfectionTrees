...
The base model is described in detail [here](model-overview.Rmd).  The basic idea is that we sample transmission trees from the set of permissible transmission trees, $\mathcal{T}_n$ and use these samples to estimate the average likelihood over a cluster.
